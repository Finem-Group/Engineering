---
name: finem-design
description: "Use for the design phase: architecture, adrs, domain modeling, ux, design system, api contracts, reliability/resilience, privacy/compliance. Work through the Finem core using original upstream specialists."
---
...
In plugin mode, supply this phase root to the core helper using `--phase` and select `finem-design`.
