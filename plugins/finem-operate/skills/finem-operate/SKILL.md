---
name: finem-operate
description: "Use for the operate phase: observability, slos, incident response, postmortem, cost/finops. Work through the Finem core using original upstream specialists."
---
...
In plugin mode, supply this phase root to the core helper using `--phase` and select `finem-operate`.
