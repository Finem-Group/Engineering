---
name: finem-build
description: "Use for the build phase: frontend, backend, auth, database, migrations, async/jobs/events, infrastructure, networking, secrets/iam, configuration/environments. Work through the Finem core using original upstream specialists."
---
...
In plugin mode, supply this phase root to the core helper using `--phase` and select `finem-build`.
