---
name: finem-cache-upstash
description: Use when this project's work involves Upstash Redis and rate limiting for a selected deployment — covers backend. Loads the original upstash skills bundled with this pack.
---
...
- `upstash:upstash-redis-js` → `upstream/upstash/skills/upstash-redis-js/SKILL.md`
- `upstash:upstash-ratelimit-js` → `upstream/upstash/skills/upstash-ratelimit-js/SKILL.md`
