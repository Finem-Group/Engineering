---
name: finem-storage-neon
description: "Use when this project's work involves Neon object storage and its provider parent — covers backend. Loads the original neon skills bundled with this pack."
---

# Finem Storage neon

Neon object storage and its provider parent
...
- `neon:neon-object-storage` → `upstream/neon/plugins/neon-postgres/skills/neon-object-storage/SKILL.md`
