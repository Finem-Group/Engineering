---
name: finem-deliver
description: "Use for the deliver phase: release, deployment, rollback. Work through the Finem core using original upstream specialists."
---
...
In plugin mode, supply this phase root to the core helper using `--phase` and select `finem-deliver`.
