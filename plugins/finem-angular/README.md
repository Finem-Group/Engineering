...
```bash
claude plugin install finem-angular@finem
```
...
codex plugin add finem-angular@finem
```
...
Native skills: 1. Bundled originals: 3 from 2 source repositories (addy, angular), unmodified under `upstream/`. See `NOTICE.md` for licenses and pinned revisions.
